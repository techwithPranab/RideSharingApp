...
const DateTimePicker: React.FC<DateTimePickerProps> = ({
  ...
  const showDatePicker = () => {
    if (Platform.OS === 'ios') {
      // For iOS, we'll use a simple approach with Alert and manual input
      // In a real app, you might want to use a custom modal with scrollable pickers
      Alert.prompt(
        title || 'Select Date',
      ...
      // For Android, show action sheet with date options
  ...
  const showTimePicker = () => {
    if (Platform.OS === 'ios') {
      ...
      // For Android, show common time slots
      const timeSlots = [
  ...
  const showDateTimePicker = () => {
    // For combined date and time, show date first, then time
    showDatePicker();
    // Note: In a real implementation, you'd want to chain these properly
  };
